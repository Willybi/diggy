...
| SR-12 | `ROADMAP.md` lu en entier via `grep` shell (lignes-monstres) → 2 tours perdus | FRICTION | sentry_triage | 2026-08-16 | 2026-08-16 | 1 | CORRIGÉ | `sentry_triage.md` Phase 1.3 : hint outil `Grep` ciblé + `head_limit`, ne pas lire ROADMAP en entier (2026-08-16) |
