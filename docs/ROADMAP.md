...
----  ------------------------------------  ----------  ----------   ------
 ...
 D6   Refonte UI listes + Radar + transverses BAS      8-12 jours   EN COURS — Explorer (p.1) livre 2026-07-21 + Radar (p.2) livre 2026-07-23 ; reste listes, Hub, Genre Detail
...
**Statut : EN COURS — Explorer (p.1) livre 2026-07-21 + Radar (p.2) livre 2026-07-23 (commits 4675445 + 53b1d62) ; le cadrage est DEJA FAIT (fiches ✅ figees avec William, revue page par page 2026-07-14). Ce chantier inscrit a la roadmap le reliquat refonte UI hors pages detail, qui n'etait planifie nulle part (constat 2026-07-20).**
