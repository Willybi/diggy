...
----  ------------------------------------  ----------  ----------   ------
 ...
 D6   Refonte UI listes + Radar + transverses BAS      8-12 jours   EN COURS — Explorer (p.1) 2026-07-21 + Radar (p.2) + Hub (p.3) 2026-07-23 + Sets liste (p.4) 2026-07-24 + Playlists liste (p.5) 2026-07-27 + Artistes liste (p.6) 2026-07-28 + Genres liste (p.7) 2026-07-31 + Genre Detail (p.8) 2026-08-04 ; les 8 pages livrees + D6.0 Suppression Rating (2026-08-04), reste la revue design Phase 5 Genre Detail
