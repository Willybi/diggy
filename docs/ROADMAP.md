...
**Estimation : 1 jour**
**Statut : TERMINE (2026-08-17 ; 0daada7, deploy_verify SAIN, AUCUN modele/migration) — AV9-01/02 livres ; RESTE AV9-03 apres ~1 semaine d'observation (verifs : runs nocturnes en success avec `deadline_hit` dans les stats crawl_logs, 0 nouvel event DIGGY-APP-T/W/J/V, aucune nouvelle ligne crawl_logs figee `running`). Inscrit 2026-08-17 (triage /sentry_triage, seul reliquat VIVANT du lot : les 11 autres issues du triage sont resolues avec leur commit en commentaire d'activite Sentry). Les 4 issues DIGGY-APP-T/W/J/V restent OUVERTES jusqu'a AV9-03.**
